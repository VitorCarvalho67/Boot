export function generateRegisterProfessorEmail(firstName: string, email: string, password: string): string {
    return `<!DOCTYPE html>
        <html>
        <head>
            <style>
            ...
            <div class="email-body">
                ...
                <div class="email-container">
                    <p class="instructions" width="400px">
                        Olá ${firstName}! você foi registrado(a) como professor(a) na plataforma Boot, aqui estão suas credenciais de acesso:
                    </p>
