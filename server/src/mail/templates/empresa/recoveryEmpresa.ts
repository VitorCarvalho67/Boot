export function generateRecoveryEmpresaEmail(firstName: string, token: string): string {
    return `<!DOCTYPE html>
        <html>
        <head>
            <style>
            ...
            <div class="email-body">
                ...
                <div class="email-container">
                    <p class="instructions" width="400px">
                        Olá ${firstName}! Este email serve para recuperação de sua conta empresarial na plataforma de maneira segura:
                    </p>
