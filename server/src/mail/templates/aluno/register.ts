export function generateRegisterEmail(firstName: string, token: string): string {
    return `<!DOCTYPE html>
        <html>
        <head>
            <style>
        ...
        <body>
            <div class="email-body">
                <div class="header">
                    Valide seu E-mail Institucional
                </div>
                ...
                <div class="email-container">
                    <p class="instructions" width="400px">
                        Olá ${firstName}! Este email serve para garantir a segurança e privacidade do usuário ao se cadastrar em nossa plataforma. Por favor, use o código abaixo para completar seu processo de registro:
                    </p>
