...
import { LoginFuncionarioDTO } from "../../dtos/LoginFuncionarioDTO";
...
export class LoginFuncionarioUseCase {
    async execute({email, password} : LoginFuncionarioDTO): Promise<{token: string, funcionario: Pick<Funcionario, 'name' | 'email' | 'tituloPrincipal'>}>{
