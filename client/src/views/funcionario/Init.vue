    ...
    <main>
      <div class="box">
        <form @submit.prevent="submitForm">
          ...
          <p class="p">Para acessar sua área exclusiva de profissionais na plataforma, por favor, insira seu e-mail cadastrado e seu cargo</p>
          <div class="input-box" :class="{ 'focused': emailFocused }">
            <label for="email">E-Mail</label>
            <input type="email" id="email" v-model="funcionario.email" required @focus="emailFocused = true" @blur="emailFocused = false">
          </div>
